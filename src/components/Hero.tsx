...
export function Hero({ onMovieSelect }: { onMovieSelect: (id: string, type: string) => void }) {
  ...
  if (loading || movies.length === 0) {
    return (
      <div className="w-full min-h-[100dvh] h-[100dvh] relative overflow-hidden bg-[#0a0a0f] border-b border-white/5 select-none" role="status" aria-label="Loading featured content">
        {/* Backdrop Shimmer */}
