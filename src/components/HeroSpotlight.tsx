          ...
          <div className="absolute inset-0 flex items-center px-4 md:px-10 max-w-[1600px] mx-auto">
            <div className="max-w-2xl mt-16 md:mt-0">
              ...
              <motion.div 
                ...
                className="flex items-center gap-4 text-sm md:text-base text-cv-cream mb-6"
              >
                <span className="flex items-center text-cv-gold font-bold">
              ...
              <motion.p 
                ...
                className="text-sm md:text-base text-cv-slate mb-8 line-clamp-3 md:line-clamp-4 max-w-xl"
              >
              ...
              >
                <button 
                  ...
                  className="px-8 py-3 bg-cv-gold text-cv-gold-content font-bold rounded-lg hover:bg-cv-gold-light transition-colors flex items-center gap-2 shadow-[0_0_20px_rgba(212,168,83,0.3)]"
                >
                ...
                <button 
                  ...
                  className="px-8 py-3 bg-white/10 text-white font-bold rounded-lg hover:bg-white/20 transition-colors flex items-center gap-2 backdrop-blur-md border border-white/10"
                >
        ...
        {movies.map((_, idx) => (
          <button
            ...
            className={`w-2.5 h-2.5 rounded-full transition-all ${
              idx === currentIndex ? 'bg-cv-gold w-8' : 'bg-white/30 hover:bg-white/50'
            }`}
          />
        ))}
      </div>
