          ...
          <div className="w-full max-w-5xl mx-auto px-4 md:px-8 py-8 flex-1 flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto py-8 scrollbar-hide">
              {query.length > 1 ? (
                results.length > 0 ? (
                  <div>
                    <h3 className="text-lg text-muted-foreground mb-6 font-display flex items-center gap-2">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                      {results.map((movie, idx) => (
                        ...
                        >
                          ...
                          <h4 className="font-display font-semibold text-foreground group-hover:text-brand transition-colors line-clamp-1">{movie.title}</h4>
                ...
                <div className="space-y-10">
                  {history.length > 0 && (
                    <div>
                      <h3 className="text-lg text-muted-foreground mb-4 font-display flex items-center gap-2">
