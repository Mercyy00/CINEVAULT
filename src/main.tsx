...
const manifest = {
  ...
  theme_color: "#d4a853",
  icons: [
    { src: "https://picsum.photos/192/192?random=cinevault", sizes: "192x192", type: "image/png" },
    { src: "https://picsum.photos/512/512?random=cinevault", sizes: "512x512", type: "image/png" }
  ]
};
